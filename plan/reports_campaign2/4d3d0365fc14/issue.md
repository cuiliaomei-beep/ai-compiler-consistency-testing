# [nnsmith compile] Incorrect result when `layout` changes
...
This test was generated because the static analysis found: layout read, or alias structure is written through (factor `self.is_contiguous()`, oracles ['value', 'metadata', 'alias', 'mutation']).
