# [nnsmith compile] Incorrect result when `dtype` changes
...
This test was generated because the static analysis found: numerics depend on precision regardless of source (factor `self.dtype`, oracles ['value', 'metadata', 'mutation', 'alias']).
