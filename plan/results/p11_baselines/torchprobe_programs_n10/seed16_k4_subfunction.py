def forward(mlist, v9_0):
    ...
    def subfunc(v10_0):
        ...
        return (v2_0, v8_0, v7_0, v6_0)
    v2_0, v8_0, v7_0, v6_0 = subfunc(v10_0)
    v4_0 = v6_0.to(dtype=torch.float64)
    v5_0 = torch.nn.functional.gelu(v6_0)
    if v5_0.min() < v9_0.mean():
        backup = v7_0[0, 0, 1].clone()
        v7_0[0, 0, 1] = 0.9795723557472229
        v3_0 = v5_0.mean(0)
        v0_0 = torch.gt(v5_0, v3_0)
        v1_0 = torch.zeros(torch.Size([1, 2]), dtype=torch.bool, device='cpu')
        for i in range(0, 1):
            v1_0[i, :] = torch.gt(v3_0[i, :], v3_0[i, :])
        v7_0[0, 0, 1] = backup
