def forward(mlist, v13_0, v1_0):
    ...
    def subfunc(v14_0):
        ...
        return (v2_0, v8_0, v10_0)
    v2_0, v8_0, v10_0 = subfunc(v14_0)
    v12_0 = torch.neg(v10_0)
    v7_0 = torch.tan(v10_0)
    v6_0 = v7_0.max(0).values
    v5_0 = torch.nn.functional.leaky_relu(v1_0)
    if v5_0 >= v6_0.shape[0]:
        v4_0 = v6_0.to(dtype=torch.float64)
        v11_0 = v4_0.to(dtype=torch.float32)
        v0_0 = torch.zeros(torch.Size([1]), dtype=torch.float64, device='cpu')
        for i in range(0, 1):
            v0_0[i] = torch.nn.functional.leaky_relu(v4_0[i])
