def forward(mlist, v22_0, v18_0, v2_0):
    ...
    v10_0 = torch.zeros(torch.Size([2]), dtype=torch.float64, device='cpu')
    for i in range(0, 2):
        v10_0[i] = torch.cos(v4_0[i])
    ...
    def subfunc(v12_0, v19_0):
        if v23_0.max() >= v19_0[1, 1558]:
            v20_0 = v12_0.sum(1)
            v15_0 = torch.lt(v4_0, v12_0)
        return (v15_0, v20_0)
    v15_0, v20_0 = subfunc(v12_0, v19_0)
    v16_0[0, 0, 0] = backup
