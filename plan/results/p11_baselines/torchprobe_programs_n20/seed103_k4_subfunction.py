def forward(mlist, v20_0, v22_0, v4_0, v15_0, v7_0):
    ...
    def subfunc(v16_0, v11_0, v9_0):
        v6_0 = torch.div(v13_0, v9_0)
        v3_0 = torch.sin(v6_0)
        v5_0 = torch.cos(v3_0)
        v0_0 = v3_0.argmin(2)
        v8_0 = torch.eq(v0_0, v0_0)
        if v11_0.min() >= v16_0.shape[0]:
            backup = v9_0[1, 64, 1, 2, 0].clone()
            v9_0[1, 64, 1, 2, 0] = 0.5807490944862366
            v1_0 = v6_0.to(dtype=torch.int64)
            v2_0 = v1_0.max(3).values
        return (v6_0, v0_0, v8_0, v2_0, v5_0, v3_0, v9_0, backup, v1_0)
    v6_0, v0_0, v8_0, v2_0, v5_0, v3_0, v9_0, backup, v1_0 = subfunc(v16_0, v11_0, v9_0)
