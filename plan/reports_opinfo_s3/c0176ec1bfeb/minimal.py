...
def opinfo_nn_functional_interpolate_bicubic(*args):
    return interpolate(*args, (3, 4), scale_factor=None, mode='bicubic', align_corners=None)

args = (torch.randn(1, 2, 3, 4, 5),)

eager = opinfo_nn_functional_interpolate_bicubic(*args)
torch._dynamo.reset()
compiled = torch.compile(opinfo_nn_functional_interpolate_bicubic, backend='eager')(*args)
print('eager   :', eager)
