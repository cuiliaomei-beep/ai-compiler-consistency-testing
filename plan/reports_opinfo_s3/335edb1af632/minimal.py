...
def opinfo_nn_functional_interpolate_area(*args):
    return interpolate(*args, (3,), scale_factor=None, mode='area', align_corners=None)

args = (torch.randn(1, 2, 3, 4),)

eager = opinfo_nn_functional_interpolate_area(*args)
torch._dynamo.reset()
compiled = torch.compile(opinfo_nn_functional_interpolate_area, backend='eager')(*args)
print('eager   :', eager)
