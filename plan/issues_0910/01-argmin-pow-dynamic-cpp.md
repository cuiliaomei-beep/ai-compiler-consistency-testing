<!-- 提交信息（不要复制到 issue 里） -->
# pytorch/pytorch — issue draft 01: argmin/argmax + dynamic=True 生成 `**` 进 C++
...
| 使用的模板 | `.github/ISSUE_TEMPLATE/pt2-bug-report.yml`（🐛 torch.compile Bug Report，labels: oncall: pt2） |
